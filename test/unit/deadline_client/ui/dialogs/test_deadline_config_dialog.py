...
try:
    ...
    pytest.importorskip("deadline.client.ui.widgets.deadline_cloud_resource_combo_boxes")


class TestDeadlineResourceListComboBox:
    """Tests for _DeadlineResourceListComboBox.refresh_selected_id()"""

    @patch("deadline.client.ui.widgets.deadline_cloud_resource_combo_boxes.config_file")
