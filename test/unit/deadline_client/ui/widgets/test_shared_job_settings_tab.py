...
def test_priority_should_be_integer_within_range(shared_job_settings_tab: SharedJobSettingsWidget):
    shared_job_settings_tab.shared_job_properties_box.priority_box.setValue(50.6)
    assert shared_job_settings_tab.shared_job_properties_box.priority_box.value() == 50
...
def test_max_failed_tasks_count_should_be_integer_within_range(
    ...
    shared_job_settings_tab.shared_job_properties_box.max_failed_tasks_count_box.setValue(50.6)
    assert (
        shared_job_settings_tab.shared_job_properties_box.max_failed_tasks_count_box.value() == 50
    )
...
def test_max_retries_per_task_should_be_integer_within_range(
    ...
    shared_job_settings_tab.shared_job_properties_box.max_retries_per_task_box.setValue(50.6)
    assert shared_job_settings_tab.shared_job_properties_box.max_retries_per_task_box.value() == 50
