...
def test_name_in_custom_amount_widget_should_be_truncated(qtbot):
    widget = CustomAmountWidget(CustomRequirementsWidget().list_widget, 1)
    qtbot.addWidget(widget)
...
def test_name_in_custom_attribute_widget_should_be_truncated(qtbot):
    parent_widget = CustomRequirementsWidget()
    widget = CustomAttributeWidget(QListWidgetItem(parent_widget.list_widget), 1, parent_widget)
    qtbot.addWidget(widget)
...
def test_value_in_custom_attribute_widget_should_be_truncated(qtbot):
    parent_widget = CustomRequirementsWidget()
    widget = CustomAttributeValueWidget(QListWidgetItem(parent_widget.list_widget), parent_widget)
    qtbot.addWidget(widget)
