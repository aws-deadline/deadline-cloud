...
def navigate_shared_jobsettings_tab():
    ...
    test.compare(
        squish.waitForObjectExists(aws_submitter_locators.shared_jobsettings_properties).visible,
        True,
...
def verify_deadline_cloud_settings(farm_name: str, farm_desc: str, queue_name: str):
    ...
    test.compare(
        str(
            squish.waitForObjectExists(
                aws_submitter_locators.deadline_Cloud_settings_Deadline_Cloud_Squish_Farm_QLabel
            ).text
        ),
        farm_name,
    ...
    test.compare(
        str(
            squish.waitForObjectExists(
                aws_submitter_locators.deadline_Cloud_settings_Squish_Automation_Queue_QLabel
            ).text
        ),
        queue_name,
...
def verify_queue_environment(conda_packages: str, conda_channels: str):
    ...
    test.compare(
        str(
            squish.waitForObjectExists(
                aws_submitter_locators.queue_Environment_Conda_Conda_Packages_QLineEdit
            ).displayText
        ),
        conda_packages,
    ...
    test.compare(
        str(
            squish.waitForObjectExists(
                aws_submitter_locators.queue_Environment_Conda_Conda_Channels_QLineEdit
            ).displayText
        ),
        conda_channels,
...
def verify_conda_tooltip_texts():
    ...
    test.compare(
        str(squish.waitForObjectExists(aws_submitter_locators.condapackages_text_label).toolTip),
    ...
    test.compare(
        str(
            squish.waitForObjectExists(
                aws_submitter_locators.queue_Environment_Conda_Conda_Channels_QLabel
            ).toolTip
        ),
...
def verify_render_parameters(frames: str, output_dir: str, output_pattern: str, output_format: str):
    ...
    test.compare(
        str(
            squish.waitForObjectExists(
                aws_submitter_locators.render_Parameters_Frames_QLineEdit
            ).displayText
        ),
        frames,
    ...
    test.compare(
        str(
            squish.waitForObjectExists(
                aws_submitter_locators.render_Parameters_QLineEdit
            ).displayText
        ),
        output_dir,
    ...
    test.compare(
        str(
            squish.waitForObjectExists(
                aws_submitter_locators.render_Parameters_Output_File_Pattern_QLineEdit
            ).displayText
        ),
        output_pattern,
    ...
    test.compare(
        str(
            squish.waitForObjectExists(
                aws_submitter_locators.render_Parameters_Output_File_Format_QComboBox
            ).currentText
        ),
        output_format,
...
def verify_software_env(conda_packages: str):
    ...
    test.compare(
        str(
            squish.waitForObjectExists(
                aws_submitter_locators.software_Environment_Conda_Packages_QLineEdit
            ).displayText
        ),
        conda_packages,
