...
//Name: turntable_base_scene.ma
//Last modified: Mon, Aug 05, 2024 04:29:49 PM
//Codeset: 1252
requires maya "2023";
requires -nodeType "aiOptions" -nodeType "aiAOVDriver" -nodeType "aiAOVFilter" -nodeType "aiSkyDomeLight"
		 -nodeType "aiPhysicalSky" "mtoa" "5.1.0";
...
fileInfo "UUID" "4FFAFA64-4FB2-6F2C-3965-299C1CBE93B4";
createNode transform -s -n "persp";
	rename -uid "EABE5A35-4D0E-7D45-823E-22B756626E3F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.080361389402592 13.794205683770492 22.971308792721452 ;
	setAttr ".r" -type "double3" -26.738352730043683 -691.39999999992449 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "4D69AD8D-40E5-F483-BBC4-EF86431FEE45";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 28.145674465627899;
...
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".ff" 0;
	setAttr ".coi" 1.0539864761116131;
	setAttr ".ow" 30;
	setAttr ".imn" -type "string" "camera1";
	setAttr ".den" -type "string" "camera1_depth";
	setAttr ".man" -type "string" "camera1_mask";
createNode lightLinker -s -n "lightLinker1";
	rename -uid "629EF526-4996-BFCB-F10F-5ABF673F26C9";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "DB6BC938-4FB6-AA8E-7747-21BACCEEC969";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "AF63E09B-48BE-6EAE-826C-5B89DF38CFBC";
createNode displayLayerManager -n "layerManager";
	rename -uid "1C21248F-42E8-B841-2CF1-AB81F3A4DB96";
createNode displayLayer -n "defaultLayer";
	rename -uid "4EBD51CA-4A1A-475B-6FD1-3E9D631D86AE";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6643BABB-4EBB-F956-E93D-2F89138B1D38";
...
// End of turntable_base_scene.ma
