...
def main():
    ...
    test.compare(
        squish.waitForObjectExists(workstation_config_locators.job_hist_dir_input).displayText,
        config.job_hist_dir,
    ...
    workstation_config_helpers.open_close_job_hist_directory()
    # verify selected job history directory path is set
    test.compare(
        str(squish.waitForObjectExists(workstation_config_locators.job_hist_dir_input).displayText),
        config.job_hist_dir,
