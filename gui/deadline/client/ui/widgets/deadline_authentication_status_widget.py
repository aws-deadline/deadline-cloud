...
class DeadlineAuthenticationStatusWidget(QGroupBox):
    ...
    def _should_show_logout(self) -> bool:
        ...
        """
        return self._status.creds_source == AwsCredentialsSource.DEADLINE_CLOUD_MONITOR_LOGIN
    ...
    def _get_current_auth_state_key(self) -> AuthenticationState:
        ...
        elif self._status.auth_status == AwsAuthenticationStatus.CONFIGURATION_ERROR:
