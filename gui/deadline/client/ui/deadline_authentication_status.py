...
class DeadlineAuthenticationStatus(QObject):
    ...
    @property
    def creds_source(self) -> Optional[AwsCredentialsSource]:
        return self.__creds_source

    @property
    def auth_status(self) -> Optional[AwsAuthenticationStatus]:
    ...
    def _on_auth_status_error(self, error: BaseException) -> None:
        ...
        logger.exception(error)
        self.__auth_status = AwsAuthenticationStatus.CONFIGURATION_ERROR
        self.auth_status_changed.emit()
