...
lives in the separate [`deadline-cloud-job-attachments`](https://github.com/aws-deadline/deadline-cloud-job-attachments) repository
and is pulled in as the `deadline-job-attachments` dependency.
