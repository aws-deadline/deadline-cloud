...
pub async fn mock_get_queue_access_denied(server: &MockServer, farm_id: &str, queue_id: &str) {
    Mock::given(method("GET"))
        .and(path(format!(
...
pub async fn mock_get_fleet_not_found(server: &MockServer, farm_id: &str, fleet_id: &str) {
    Mock::given(method("GET"))
        .and(path(format!(
