...
#[cfg(test)]
mod tests {
    use crate::config_file::{normalize_path_for_config, normalize_path_from_config};
    ...
    fn get_setting_returns_path_setting_unchanged_on_unix_or_converted_on_windows() {
        use crate::config_file::get_setting;
    ...
    fn set_setting_stores_path_with_forward_slashes_on_windows() {
        use crate::config_file::set_setting;
        use crate::ini::IniConfig;
    ...
    fn non_path_setting_not_modified() {
        use crate::config_file::{get_setting, set_setting};
        use crate::ini::IniConfig;
