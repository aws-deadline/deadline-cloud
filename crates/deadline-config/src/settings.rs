...
pub struct SettingDef {
    ...
    /// If true, normalize path separators on read/write (Windows only).
    pub is_path: bool,
    /// If true, normalize each path in an OS-pathsep-delimited list (Windows only).
    pub is_path_list: bool,
}
