...
pub const DOWNLOAD_BASE_URL: &str = "https://downloads.deadlinecloud.amazonaws.com/submitters";
...
/// and `error_message`.
///
/// If `notification_enabled` is false, the check is skipped and a result
...
pub fn safe_check_for_updates(
    ...
    let platform_data = &manifest["DeadlineCloudSubmitter"]["versions"]["latest"][platform];
    if platform_data.is_null() {
        return UpdateCheckResult {
            status: UpdateCheckStatus::ParseError,
            error_message: Some(format!("Platform '{platform}' not found in manifest")),
            ..base()
        };
    }
...
mod tests {
    ...
    async fn safe_check_newer_version_available() {
        ...
        let result =
            safe_check_for_updates("deadline-cloud-for-cinema-4d", "0.9.1", true, Some(&url));
    ...
    async fn safe_check_current_is_latest() {
        ...
        let result =
            safe_check_for_updates("deadline-cloud-for-cinema-4d", "0.10.0", true, Some(&url));
    ...
    async fn safe_check_current_newer_than_manifest() {
        ...
        let result =
            safe_check_for_updates("deadline-cloud-for-cinema-4d", "1.0.0", true, Some(&url));
    ...
    async fn safe_check_integration_not_found() {
        ...
        let result =
            safe_check_for_updates("deadline-cloud-for-houdini", "1.0.0", true, Some(&url));
    ...
    async fn safe_check_platform_specific_entries() {
        ...
        let result =
            safe_check_for_updates("deadline-cloud-for-cinema-4d", "0.9.0", true, Some(&url));
    ...
    async fn safe_check_notification_disabled() {
        ...
        let result =
            safe_check_for_updates("deadline-cloud-for-cinema-4d", "0.9.1", false, Some(&url));
    ...
    fn submitter_update_notification_defaults_to_true() {
        let def = crate::config::settings::find_setting("settings.submitter_update_notification");
    ...
    async fn safe_check_pre_release_version_is_older() {
        ...
        assert!(
            ...
            "pre-release should be older than release"
        );
    }
    ...
    async fn safe_check_v_prefix_stripped() {
        ...
        let result =
            safe_check_for_updates("deadline-cloud-for-cinema-4d", "v0.9.0", true, Some(&url));
    ...
    async fn safe_check_empty_version_string() {
        ...
        let result = safe_check_for_updates("deadline-cloud-for-cinema-4d", "", true, Some(&url));
