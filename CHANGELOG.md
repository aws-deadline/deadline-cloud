...
### Features
* **experimental**: Add mcp to deadline client tools (#784) ([`af4064b`](https://github.com/aws-deadline/deadline-cloud/commit/af4064b1c0bb7455affa9987e6d031ac1e1f5afe))
...
### Bug Fixes
* concurrent job bundle submissions fail due to sqlite3 table already exist (#862) ([`b35aeb1`](https://github.com/aws-deadline/deadline-cloud/commit/b35aeb1eb3ae6955cd4f70f3c2c57f2b0d5bd900))
...
* Job submission warning dialogs are too long (#855) ([`6042295`](https://github.com/aws-deadline/deadline-cloud/commit/6042295f758fe03be0b6c69bd242bdc35990de33))
* List all invalid hidden parameters in GUI validation error (#856) ([`4fa22df`](https://github.com/aws-deadline/deadline-cloud/commit/4fa22df43abc57d053a3f68fef97c8facae12cdc))
* Remove default requirement and add validation for hidden parameters in GUI (#843) ([`dd01866`](https://github.com/aws-deadline/deadline-cloud/commit/dd0186605715d39c68fd2e42cbf3b5f8c79dd92c))
* Remove default value requirement for hidden parameters in GUI ([`dd01866`](https://github.com/aws-deadline/deadline-cloud/commit/dd0186605715d39c68fd2e42cbf3b5f8c79dd92c))
...
* Handled edge case for re-queued jobs handling sync output cli & some integ test tweaks (#845) ([`a70f0b7`](https://github.com/aws-deadline/deadline-cloud/commit/a70f0b7adeba4434247f2de29cc2dc3453322f27))
* Handled edge case for re-queued jobs handling sync output cli and some integ test tweaks ([`a70f0b7`](https://github.com/aws-deadline/deadline-cloud/commit/a70f0b7adeba4434247f2de29cc2dc3453322f27))
