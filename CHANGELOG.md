...
### Features
* add job_id parameter to get_session_logs for MCP (#996) ([`df91974`](https://github.com/aws-deadline/deadline-cloud/commit/df91974759034f8c9cbad00f30a374ad37885af1))
* improve mcp debugging by adding a steering prompt and api hooks (#995) ([`33b261d`](https://github.com/aws-deadline/deadline-cloud/commit/33b261d252879a77460448e4a40632e1cbdb9d51))
* improve MCP server tool set with debug hooks ([`33b261d`](https://github.com/aws-deadline/deadline-cloud/commit/33b261d252879a77460448e4a40632e1cbdb9d51))
* add deprecation warnings for legacy sync input and output in Job Attachments (#991) ([`5bba469`](https://github.com/aws-deadline/deadline-cloud/commit/5bba469e07e64ed228a218e0b37743e4455bde53))
* suggest available resources on CLI access errors (#985) ([`478bf6e`](https://github.com/aws-deadline/deadline-cloud/commit/478bf6e072ba6f28d612689b679fe982735c1860))
* add search term support to `deadline job get` command (#982) ([`e01b353`](https://github.com/aws-deadline/deadline-cloud/commit/e01b353849610b9ce5b177d0a5e2e8ed38d81b31))
...
### Bug Fixes
* prevent double .exe extension in handle-web-url --install (#1014) ([`bc6a2a0`](https://github.com/aws-deadline/deadline-cloud/commit/bc6a2a0a641c63bd7ae9b5766c36709a3086c72c))
* prevent double .exe extension in handle-web-url --install ([`bc6a2a0`](https://github.com/aws-deadline/deadline-cloud/commit/bc6a2a0a641c63bd7ae9b5766c36709a3086c72c))
* handle-web-url installs from command on PATH on linux (#1013) ([`42ff116`](https://github.com/aws-deadline/deadline-cloud/commit/42ff11669ec1ed6614121bbdef6ed3038a69d6e8))
* handle-web-url nstalls from command on PATH on linux ([`42ff116`](https://github.com/aws-deadline/deadline-cloud/commit/42ff11669ec1ed6614121bbdef6ed3038a69d6e8))
* sts and s3 endpoint url overrides were not being respected (#1005) ([`c7df111`](https://github.com/aws-deadline/deadline-cloud/commit/c7df1112dab7969eda65c29c71baac3d93ab4c23))
* show resource ID in dropdown when user lacks list permission (#993) ([`d4946d5`](https://github.com/aws-deadline/deadline-cloud/commit/d4946d578568ea26f3ba25285bba9677d844d64c))
* update Squish test selectors to locate elements in current deadline GUI (#988) ([`64ef7c9`](https://github.com/aws-deadline/deadline-cloud/commit/64ef7c96790ee49a8b6d0edd74511602731f9a20))
* use string list filter for job download (#994) ([`34d98eb`](https://github.com/aws-deadline/deadline-cloud/commit/34d98eb2b62e22be210f461277a5a51871bb40d3))
* load job bundle button text too long for default UI width (#980) ([`9f77ba2`](https://github.com/aws-deadline/deadline-cloud/commit/9f77ba29de66e68249b1ea704372e9c25ec0f587))
